abstract class AppAssets{
  ...
  // static const String splashBackground = "${baseImagesPath}splash.png";
  static const String splashLogo = "${baseImagesPath}splash.png";
  ...
  static const String imageTest = "${baseImagesPath}test.jpg";
